...
Following code will generate an bioMatrix layout image with the build-in demo 
data.

<<caOmicsVBioMatrixLayoutDemo>>=
library(caOmicsV)
...
\includegraphics[width=\textwidth]{caOmicsV_bioMatrix_Layout_Plot.png}

Figure 1. caOmicsV bioMatrix layout plot\\

Run the code below will get an image in bioNetCircos layout with the build-in 
demo data.

<<caOmicsVbionetCircosLayoutDemo>>=
...
\includegraphics[width=\textwidth]{caOmicsV_bioNetCircos_Layout_Plot.png}
...
The layoue will look like below. \\

\includegraphics[width=\textwidth]{caOmicsV_bioMatrix_Layout_Demo.png}

Figure 3. caOmicsV bioMatrix layout \\
...
desired location for node name (gene) labelling then label each node (the node 
index here may be different from your graph).\\

\includegraphics[width=\textwidth]{caOmicsV_bionetcircos_node_layout.png}

Figure 4. caOmicsV bioNetCircos node layout
...
\includegraphics[width=\textwidth]{caOmicsV_bionetcircos_plot_manually.png}

Figure 5. caOmicsV bioNetCircos plot
